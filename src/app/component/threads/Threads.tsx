...
const Threads: React.FC<ThreadsProps> = ({
	...
	useLayoutEffect(() => {
		...
		const ctx = gsap.context(() => {
			...
			// If sizes/DOM changed (canvas insertion/resize), recalc start/end positions [web:27]
			...
			// custom cleanup called on ctx.revert() [web:32]
			return () => {
		...
		// revert kills all tweens/ScrollTriggers created in the context [web:32]
		return () => ctx.revert();
